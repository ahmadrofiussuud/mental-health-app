        ...
        <div class="flex justify-between h-20">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-4 py-2 border border-gray-200 text-sm leading-4 font-medium rounded-full text-gray-700 bg-gray-50 hover:bg-white hover:shadow-md focus:outline-none transition ease-in-out duration-150 gap-2">
                            <div class="w-6 h-6 rounded-full bg-teal-500 flex items-center justify-center text-white text-xs">
