                ...
                <div className="flex justify-between h-20">
                    <div className="flex items-center">
                        ...
                        <Link href="/" className="flex items-center gap-2 group shrink-0">
                            {/* <div className="w-8 h-8 bg-teal-500 rounded-lg flex items-center justify-center text-white font-bold text-lg shadow-sm">
                                M
                            </div> */}
                            {/* Using Flower2 as a placeholder for the Lotus logo */}
